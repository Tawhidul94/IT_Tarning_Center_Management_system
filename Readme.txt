-- It Tarning Center MANAGEMENT APPLICATION --
...
Manage students:
  - New student accounts can be created and Update and delete. 
  - There is a button to display a table of all students. 
  - Single students can be managed by searching with their id. 
  - When the student is found, their account password can be reset and all grades can be viewed of this particular
    student. 

Manage teachers: 
  - New teachers accounts can be created ,Update,delete. 
  - There is a button to display a table of all teachers. 
  - Single teachers can be managed by searching with their id. 
